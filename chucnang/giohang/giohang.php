<div id="cart">
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tbody>
            <tr>
                ...
                <td data-th="Quantity">
                    <input type="number" name="sl[<?php echo $row['id_sp']; ?>]" min="1" class="form-control text-center" value="<?php echo $_SESSION['giohang'][$row['id_sp']]; ?>">
                </td>
                <td data-th="Subtotal" class="text-center"><span><?php echo $totalPrice ?></span></td>
                <td class="actions" data-th="">
                    <a class="btn btn-danger btn-sm" href="chucnang/giohang/xoahang.php?id_sp=<?php echo $row['id_sp']; ?>">Xóa</a>
                </td>
            </tr>
        </tbody>
        <?php 
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="2" class="hidden-xs">
                    <a href="chucnang/giohang/xoahang.php?id_sp=0" class="btn btn-danger btn-sm">Xóa tất cả sản phẩm</a>
                </td>
    ...
    echo '<script>alert("khong co san pham tro gio hang")</script>';
} ?>
</div>